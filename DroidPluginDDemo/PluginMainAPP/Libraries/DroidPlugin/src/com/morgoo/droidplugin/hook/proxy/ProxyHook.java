...
public abstract class ProxyHook extends Hook implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        try {
            Log.e("star","IActivityManagerHook  isEnable===="+isEnable());
            if (!isEnable()) {
                return method.invoke(mOldObj, args);
            }
            HookedMethodHandler hookedMethodHandler = mHookHandles.getHookedMethodHandler(method);
            if (hookedMethodHandler != null) {
                Log.e("star","IActivityManagerHook  hookedMethodHandler   not  null====");
                return hookedMethodHandler.doHookInner(mOldObj, method, args);
            }
            Log.e("star","IActivityManagerHook  hookedMethodHandler   is  null====");
            return method.invoke(mOldObj, args);
